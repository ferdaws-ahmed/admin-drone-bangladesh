...
import { InputGroup, SelectGroup } from './FormHelpers';
import { Upload, X, Image as ImageIcon, Tag, DollarSign, Layers, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4 sm:p-5 shadow-xs space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <InputGroup label="Drone Full Title" placeholder="e.g. DJI Mini 5 Pro" value={data.title} onChange={(v) => update('title', v)} required />
